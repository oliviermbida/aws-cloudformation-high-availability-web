...
####################################################################################################################
# arn:aws:cloudformation:us-east-1:803394216630:stack/test-stack/6887e610-e3e7-11ec-aa37-0ae4eeddd69d
# cfn-803394216630-bucket
# Options to name your packaged stacks and your S3 bucket

source ./update.sh $1 ../templates/stacks.yaml $2 $3 CREATE